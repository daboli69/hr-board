...
PARK_GEO = {
    "Coors Field":             (347,390,415,375,350,  8, 8, 8,14, 8, 39.7559,-104.9942,   0, 1580),
    ...
    "Wrigley Field":           (355,368,400,368,353, 11,11,11,11,11, 41.9484, -87.6553,  30,  200),
    "Dodger Stadium":          (330,385,395,385,330,  8, 8, 8, 8, 8, 34.0739,-118.2400,  50,   80),
    "Oracle Park":             (339,364,391,415,309,  8, 8, 8, 8,24, 37.7786,-122.3893,  90,    0),
    "Petco Park":              (334,367,396,391,322,  8, 8, 8, 8, 8, 32.7073,-117.1566,   0,   20),
    "Citizens Bank Park":      (329,374,401,369,330, 12, 8, 8, 6,13, 39.9061, -75.1665,   0,   20),
    "Great American Ball Park":(328,379,404,370,325, 12, 8, 8, 8, 8, 39.0975, -84.5067,  30,  150),
    "Globe Life Field":        (329,372,407,374,326, 14, 8, 8, 8, 8, 32.7473, -97.0837,   0,  170),
    "Truist Park":             (335,385,400,375,325,  8, 8, 8, 8,16, 33.8907, -84.4677,   0,  320),
    "Chase Field":             (330,374,407,374,334,  8, 8,25, 8, 8, 33.4455,-112.0667,   0,  340),
    "Oriole Park at Camden Yards":(333,364,410,373,318, 7, 7, 7, 7,25, 39.2839,-76.6217,  0,   10),
    "Camden Yards":            (333,364,410,373,318,  7, 7, 7, 7,25, 39.2839, -76.6217,   0,   10),
    "Rogers Centre":           (328,375,400,375,328, 10,10,10,10,10, 43.6414, -79.3894,   0,   90),
    "American Family Field":   (342,371,400,374,345,  8, 8, 8, 8, 8, 43.0280, -87.9712,   0,  200),
    ...
    "loanDepot park":          (344,386,400,387,335,  8, 8, 8, 8, 8, 25.7781, -80.2197,  30,    2),
    "T-Mobile Park":           (331,378,401,381,326,  8, 8, 8, 8, 8, 47.5914,-122.3325,   0,    5),
    "Kauffman Stadium":        (330,387,410,387,330,  8, 8, 8, 8, 8, 39.0517, -94.4803,   0,  230),
    "Comerica Park":           (342,370,412,365,330,  8, 8, 8, 8, 8, 42.3390, -83.0485,   0,  180),
    "Progressive Field":       (325,370,405,375,325, 19, 8, 8, 8, 8, 41.4962, -81.6852,   0,  200),
    "Rate Field":              (330,377,400,372,335,  8, 8, 8, 8, 8, 41.8299, -87.6338,   0,  180),
    "Guaranteed Rate Field":   (330,377,400,372,335,  8, 8, 8, 8, 8, 41.8299, -87.6338,   0,  180),
    "Target Field":            (339,377,404,367,328,  8, 8, 8,23, 8, 44.9817, -93.2776,   0,  250),
    "Busch Stadium":           (336,375,400,375,335,  8, 8, 8, 8, 8, 38.6226, -90.1928,   0,  140),
    "PNC Park":                (325,389,399,375,320,  6, 8, 8, 8,21, 40.4469, -80.0057,   0,  220),
    "Angel Stadium":           (330,387,396,370,330,  8, 8, 8,18,18, 33.8003,-117.8827,   0,   50),
    "Daikin Park":             (315,366,409,373,326, 19, 8, 8, 8, 7, 29.7572, -95.3555,  30,   10),
    "Minute Maid Park":        (315,366,409,373,326, 19, 8, 8, 8, 7, 29.7572, -95.3555,  30,   10),
    "Sutter Health Park":      (330,375,403,375,325,  8, 8, 8, 8, 8, 38.5802,-121.5141,   0,   10),
