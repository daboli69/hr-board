...
(() => {
 ...
 renderView=function(){if(!BOARD)return originalRender();if(view==='pregame-record')renderEvidence();else if(view==='market-disagreement')renderMarket();else if(view==='fantasy-research')renderFantasy();else originalRender();};
